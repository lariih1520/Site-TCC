...
*/
  ...
  class RedeSocial
  {
    ...
    public function Cadastrar($rede){
      ...
      $sql = "insert into tbl_rede(nome_rede, link, foto, hexadecimal)";
      $sql = $sql."values('".$rede->nome_rede."','".$rede->link."','".$rede->foto."','".$rede->cor."')";
    ...
    public function ListarTodos(){
      ...
      if(mysql_query($sql)){
        ...
        while($rs = mysql_fetch_array($select)){
          ...
          $lista[$contador]->cor = $rs['hexadecimal'];
    ...
    public function ListarPorId($rede){
      ...
      if(mysql_query($sql)){
        ...
        if($rs = mysql_fetch_array($select)){
          ...
          $rede_listar->cor = $rs['hexadecimal'];
    ...
    public function Alterar($rede){
      ...
      $sql = $sql." hexadecimal = '".$rede->cor."' where id_rede = ".$rede->id_rede;
